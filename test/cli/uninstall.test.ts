...
import { fileExists } from "../../src/cli/commands/install-utils";
import { handleUninstallCommand, parseUninstallArgs } from "../../src/cli/commands/uninstall";
    ...
    try {
      ...
      try {
        ...
        expect(result.stdout).toContain(
          "Warning: DYSFLOW_HOME is still set in your process environment",
        );
        expect(result.stdout).toContain(
          "Warning: DYSFLOW_RUNTIME_MARKER_PATH is still set in your process environment",
        );
      } finally {
