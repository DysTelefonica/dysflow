...
function buildToolCases(): ToolCase[] {
  ...
  cases.push(
    ...
    t("delete_module", "happy", { projectId, moduleName: "TestAnotherModule" }, 60_000),
    t("delete_module", "sad", { projectId, moduleName: "NoSuchModule_xyz_999" }, 60_000),
    t("list_objects", "happy", { projectId, filter: "*" }, 60_000),
    t("exists", "happy", { projectId, moduleName: "TestGoodModule" }, 60_000),
    t("exists", "sad", { projectId, moduleName: "NoSuchModule_xyz_999" }, 60_000),
    t("compile_vba", "happy", { projectId }, 60_000),
