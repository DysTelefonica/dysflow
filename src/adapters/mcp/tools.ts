...
export const LEGACY_TOOL_SCHEMAS: Record<string, JsonObjectSchema> = {
  ...
  // ---- VBA sync tools ----
  export_modules: { type: "object", additionalProperties: false, properties: { ...CTX, ...ACCESS_OVERRIDE, ...STRICT_CTX, moduleNames: SCHEMA_PROPS.moduleNames, filter: SCHEMA_PROPS.filter, destinationRoot: SCHEMA_PROPS.destinationRoot } },
  export_all: { type: "object", additionalProperties: false, properties: { ...CTX, ...ACCESS_OVERRIDE, ...STRICT_CTX, filter: SCHEMA_PROPS.filter, diff: SCHEMA_PROPS.diff } },
  ...
  verify_binary: { type: "object", additionalProperties: false, properties: { ...CTX, ...ACCESS_OVERRIDE, ...STRICT_CTX, moduleNames: SCHEMA_PROPS.moduleNames, diff: SCHEMA_PROPS.diff } },
  reconcile_binary: { type: "object", additionalProperties: false, properties: { ...CTX, ...ACCESS_OVERRIDE, ...STRICT_CTX, moduleNames: SCHEMA_PROPS.moduleNames, diff: SCHEMA_PROPS.diff } },
  delete_module: { type: "object", additionalProperties: false, properties: { ...CTX, ...ACCESS_OVERRIDE, moduleName: SCHEMA_PROPS.moduleName } },
  generate_erd: { type: "object", additionalProperties: false, properties: { ...CTX, ...ACCESS_OVERRIDE, erdPath: SCHEMA_PROPS.erdPath } },
  fix_encoding: { type: "object", additionalProperties: false, properties: { ...CTX, ...ACCESS_OVERRIDE, location: SCHEMA_PROPS.location } },
