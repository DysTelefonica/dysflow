  ...
  const currentTools: DysflowMcpTool[] = [
    {
      ...
      handler: async (input, context) => {
        ...
        return translateCoreResultToMcpContent(
          await services.vbaService.execute(input as AccessVbaRequest, context?.sendProgress),
        );
      },
    },
    {
      ...
      handler: async (input, context) => {
        ...
        return translateCoreResultToMcpContent(
          await services.queryService.execute(input as AccessQueryRequest, context?.sendProgress),
        );
      },
    },
    {
      ...
      handler: async (input) => {
        ...
        if (validation !== undefined) return invalidInput(validation);
        return translateCoreResultToMcpContent(
          await services.diagnosticsService.run(input as AccessDiagnosticsRequest),
        );
      },
    },
    {
