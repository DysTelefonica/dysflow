...
export type CliCommandContext = {
  ...
  /**
   * Injectable for testing doctor's codegraph supplement drift check.
   * Pass `false` to opt out of the check entirely (production path
   * defaults to running the check).
   */
