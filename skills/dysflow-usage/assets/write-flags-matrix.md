...
> **Source of truth**: candidate-runtime `bootstrap`, full capabilities, schema index/full, and selective `describe_tool` captures verified for the v4.2.0 release on 2026-08-26. The runtime is authoritative; this file is the human-readable mirror.
>
