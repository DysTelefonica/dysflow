...
> **Source of truth**: candidate-runtime full schema and selective `describe_tool({name:"<X>"}).errorCodes` captures verified for the v4.4.6 release on 2026-09-20. The runtime is authoritative.
>
