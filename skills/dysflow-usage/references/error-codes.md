...
> **Source of truth**: candidate-runtime full schema and selective `describe_tool({name:"<X>"}).errorCodes` captures verified for the v4.2.5 release on 2026-08-26. The runtime is authoritative.
>
