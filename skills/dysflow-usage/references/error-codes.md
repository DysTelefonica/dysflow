...
> **Source of truth**: candidate-runtime full schema and selective `describe_tool({name:"<X>"}).errorCodes` captures verified for the v4.3.1 release on 2026-09-02. The runtime is authoritative.
>
