...
> **Source of truth**: candidate-runtime full schema and selective `describe_tool({name:"<X>"}).errorCodes` captures verified for the v4.4.1 release on 2026-09-15. The runtime is authoritative.
>
